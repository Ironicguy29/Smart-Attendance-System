...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  private ActivityRegisterBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnRegister,
      @NonNull TextInputEditText etConfirmPassword, @NonNull TextInputEditText etDepartment,
      @NonNull TextInputEditText etEmail, @NonNull TextInputEditText etName,
      @NonNull TextInputEditText etPassword, @NonNull TextInputEditText etRollNo,
      @NonNull ProgressBar progressBar, @NonNull RadioGroup radioGroupRole,
      @NonNull RadioButton rbStudent, @NonNull RadioButton rbTeacher,
      @NonNull TextInputLayout tilRollNo, @NonNull TextView tvLogin) {
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tilRollNo;
      TextInputLayout tilRollNo = ViewBindings.findChildViewById(rootView, id);
      if (tilRollNo == null) {
        break missingId;
      }
      ...
      return new ActivityRegisterBinding((ScrollView) rootView, btnRegister, etConfirmPassword,
          etDepartment, etEmail, etName, etPassword, etRollNo, progressBar, radioGroupRole,
          rbStudent, rbTeacher, tilRollNo, tvLogin);
    }
