...
public final class ItemSessionBinding implements ViewBinding {
  ...
  private ItemSessionBinding(@NonNull CardView rootView, @NonNull TextView tvDate,
      @NonNull TextView tvPresent, @NonNull TextView tvStatus, @NonNull TextView tvSubject) {
  ...
  public static ItemSessionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemSessionBinding((CardView) rootView, tvDate, tvPresent, tvStatus, tvSubject);
    }
