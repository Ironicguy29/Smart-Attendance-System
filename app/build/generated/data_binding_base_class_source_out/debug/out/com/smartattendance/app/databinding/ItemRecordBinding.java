...
public final class ItemRecordBinding implements ViewBinding {
  ...
  private ItemRecordBinding(@NonNull CardView rootView, @NonNull TextView tvCoords,
      @NonNull TextView tvRollNo, @NonNull TextView tvStatus, @NonNull TextView tvStudentName,
  ...
  public static ItemRecordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemRecordBinding((CardView) rootView, tvCoords, tvRollNo, tvStatus, tvStudentName,
          tvTime);
    }
